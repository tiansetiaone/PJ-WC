...
export type AdapterName<T extends string = string> = T & {
    __brand__: 'AdapterName';
};
...
export declare abstract class Adapter<Name extends string = string> extends EventEmitter<AdapterEvents> implements AdapterProps {
